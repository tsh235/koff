export class Pagination {
  ...
  update({currentPage, totalPages, totalProducts, limit}) {
    // выводим количество товаров из общего количества товаров
    ...
    this.paginationCurrent.textContent = currentPage; //Выводит номер страницы на которой находится пользователь
    this.paginationTotal.textContent = totalPages; // выводит общее количество страниц с товарами

    // Функционал листания страниц
  ...
  create() {
    ...
    paginationCount.classList.add('pagination__count');
